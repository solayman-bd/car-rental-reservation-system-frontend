...
const DeleteModalForAdmin: React.FC<IDeleteModalProps> = ({
  setDeleteModalInfo,
  deleteModalInfo,
}) => {
  // Use the mutation hook at the top level
  const [deleteACar, { isLoading }] = useDeleteACarMutation();
  ...
  const confirmDelete = async () => {
    ...
    setDeleteModalInfo({ isOpen: false, car: null });
  };
...
export default DeleteModalForAdmin;
